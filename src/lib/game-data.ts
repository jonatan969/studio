...
export const SUPER_ARTS: SuperArt[] = [
  { id: 'super-1', name: 'Galactic Fury', description: 'Unleash a torrent of cosmic energy, dealing massive damage to a single target.' },
  { id: 'super-2', name: 'Temporal Shift', description: 'Rewind time by 3 seconds, resetting health, position, and cooldowns.' },
  { id: 'super-3', name: 'Aegis Protocol', description: 'Create an unbreakable shield around your entire team for 5 seconds.' },
];
